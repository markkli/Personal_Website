...
export default function About() {
  return (
    <section id="about" className="py-24 bg-night px-6">
      <div className="max-w-4xl mx-auto">
        <FadeIn>
          <p className="text-xs font-semibold uppercase tracking-widest text-aurora-green mb-3">About</p>
        ...
        <div className="grid md:grid-cols-5 gap-12 items-start">
          ...
          <FadeIn delay={0.15} className="md:col-span-2 flex flex-col gap-3">
            <a
              ...
              className="flex items-center gap-3 px-4 py-3 rounded-lg border border-white/10 bg-night-card text-slate-300 hover:border-aurora-green/40 hover:text-aurora-green transition-colors cursor-pointer group"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 px-4 py-3 rounded-lg border border-white/10 bg-night-card text-slate-300 hover:border-aurora-teal/40 hover:text-aurora-teal transition-colors cursor-pointer group"
            >
              <svg className="w-4 h-4 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
