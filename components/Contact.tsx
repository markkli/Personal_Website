          ...
          {contactLinks.map((link, i) => (
            <FadeIn key={link.label} delay={i * 0.1}>
              <a
                ...
                className="flex items-center gap-3 border border-slate-200 rounded-xl px-6 py-4 bg-white text-slate-700 hover:border-accent hover:text-accent hover:shadow-md hover:shadow-blue-50 transition-all duration-200 group"
              >
                <span className="text-slate-400 group-hover:text-accent transition-colors">
                  {link.icon}
                </span>
                <div>
                  <div className="text-xs font-semibold uppercase tracking-wider text-slate-400 group-hover:text-accent/70 transition-colors">
                    {link.label}
                  </div>
